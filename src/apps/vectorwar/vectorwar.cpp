 ...
 */
void
VectorWar_Init(HWND hwnd, unsigned short localport, int num_players, GGPOPlayer *players, int num_spectators, ConnectionManager* connection_manager)
{
...
#else
   result = ggpo_start_session(&ggpo, &cb, connection_manager, "vectorwar", num_players, sizeof(int), localport);
#endif
 ...
 */
void
VectorWar_InitSpectator(HWND hwnd, unsigned short localport, int num_players, int connection_id, ConnectionManager* connection_manager)
{
   GGPOErrorCode result;
   renderer = new GDIRenderer(hwnd);
   ...
   result = ggpo_start_spectating(&ggpo, &cb, connection_manager, "vectorwar", num_players, sizeof(int), localport, connection_id);
