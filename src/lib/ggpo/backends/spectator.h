...
public:
   SpectatorBackend(GGPOSessionCallbacks *cb, const char *gamename, ConnectionManager* connection_manager, int localport, int num_players, int input_size, int connection_id);
